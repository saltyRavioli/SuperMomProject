...
app.get('/beauty', function (req, res) {
    dbConnection.query(`select *from product where category = 'make up'`, function (err, result, field) {
        if (err) {
            console.log(err)
        } else {
            res.render('orders', { // 'posts' <-- whatever's in here should match the filename in the views folder
...
app.get('/fashion', function (req, res) {
    dbConnection.query(`select *from product_order where category = 'skin care'`, function (err, result, field) {
        if (err) {
            console.log(err)
        } else {
            res.render('orders', { // 'posts' <-- whatever's in here should match the filename in the views folder
...
app.get('/familyproduct', function (req, res) {
    dbConnection.query(`select *from product_order where category = 'family product'`, function (err, result, field) {
        if (err) {
            console.log(err)
        } else {
            res.render('orders', { // 'posts' <-- whatever's in here should match the filename in the views folder
...
app.get('/babyproducts', function (req, res) {
    dbConnection.query(`select *from product_order where category = 'baby products'`, function (err, result, field) {
        if (err) {
            console.log(err)
        } else {
            res.render('orders', { // 'posts' <-- whatever's in here should match the filename in the views folder
...
app.get('/Sale', function (req, res) {
    dbConnection.query(`select *from product_order where product_status = 'Sale'`, function (err, result, field) {
        if (err) {
            console.log(err)
        } else {
            res.render('orders', { // 'posts' <-- whatever's in here should match the filename in the views folder
